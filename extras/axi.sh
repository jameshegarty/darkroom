...
# sshpass -p 'root'
scp ../../helloaxi/processimage $1.axi.bit ../$INPUT_FILE root@192.168.2.2:$WRITE_PATH
ssh root@$ADDR "cat $WRITE_PATH/$1.axi.bit > /dev/xdevcfg"
ssh root@192.168.2.2 "$WRITE_PATH/processimage 805339136 $WRITE_PATH/$INPUT_FILE $WRITE_PATH/out.raw"
scp root@192.168.2.2:$WRITE_PATH/out.raw $1.axi.raw
ssh root@192.168.2.2 "rm $WRITE_PATH/processimage $WRITE_PATH/$INPUT_FILE $WRITE_PATH/out.raw $WRITE_PATH/$1.axi.bit"
